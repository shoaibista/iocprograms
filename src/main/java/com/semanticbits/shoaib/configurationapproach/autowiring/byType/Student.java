package com.semanticbits.shoaib.configurationapproach.autowiring.byType;
...
public class Student {
    ...
    public static void main(String[] args){
        ApplicationContext context=ApplicationContextFactory.getApplicationContext("autowire-byType.xml");
